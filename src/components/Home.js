...
import '../css/material.cyan-light_blue.min.css'
...
const SideBar = () => (
  <div className="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
    <header className="demo-drawer-header">
      <img src={userImage} className="demo-avatar"/>
    ...
    <nav className="demo-navigation mdl-navigation mdl-color--blue-grey-800">
      ...
      <Link className="mdl-navigation__link" to='/'><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">local_offer</i>Promos</Link>
      <Link className="mdl-navigation__link" to='/'><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">shopping_cart</i>Purchases</Link>
      <Link className="mdl-navigation__link" to='/'><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">people</i>Social</Link>
      <div className="mdl-layout-spacer"></div>
      <Link className="mdl-navigation__link" to='/'><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">help_outline</i><span className="visuallyhidden">Help</span></Link>
    </nav>
  </div>
)
